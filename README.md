# HW 7: logistic regression [![project7](https://github.com/zackmawaldi/HW7-Regression/actions/workflows/test.yml/badge.svg)](https://github.com/zackmawaldi/HW7-Regression/actions/workflows/test.yml)
